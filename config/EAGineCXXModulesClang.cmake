...
function(eagine_add_module EAGINE_MODULE_PROPER)
	...
	if(NOT ${EAGINE_MODULE_FRAGMENT} IN_LIST EAGINE_MODULE_INTERFACES)
		if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/${EAGINE_MODULE_FRAGMENT}.cpp")
			list(APPEND EAGINE_MODULE_INTERFACES ${EAGINE_MODULE_FRAGMENT})
		endif()
	endif()
