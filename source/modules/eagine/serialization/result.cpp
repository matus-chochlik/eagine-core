...
export enum class serialization_error_code : std::uint8_t {
...
export enum class deserialization_error_code : std::uint16_t {
    /// @brief Value type or format not supported.
    not_supported = 1U << 0U,
...
/// @see deserialization_errors
export using serialization_errors = bitfield<serialization_error_code>;

/// @brief Alias for deserialization error bitfield.
/// @ingroup serialization
/// @see deserialization_result
/// @see serialization_errors
export using deserialization_errors = bitfield<deserialization_error_code>;
//------------------------------------------------------------------------------
