...
void vect_data_default_construct_TV(Suite& s) {
    ...
    typename eagine::simd::data<T, 1, V>::type v1{};
    test.constructed(v1, "v1");
    typename eagine::simd::data<T, 2, V>::type v2{};
    test.constructed(v2, "v2");
    typename eagine::simd::data<T, 3, V>::type v3{};
    test.constructed(v3, "v3");
    typename eagine::simd::data<T, 4, V>::type v4{};
    test.constructed(v4, "v4");
    typename eagine::simd::data<T, 5, V>::type v5{};
    test.constructed(v5, "v5");
    typename eagine::simd::data<T, 6, V>::type v6{};
    test.constructed(v6, "v6");
    typename eagine::simd::data<T, 7, V>::type v7{};
    test.constructed(v7, "v7");
    typename eagine::simd::data<T, 8, V>::type v8{};
...
void vect_data_initialization_TV(Suite& s) {
    ...
    typename eagine::simd::data<T, 1, V>::type v1 = {T(1)};
    test.constructed(v1, "v1");
    typename eagine::simd::data<T, 2, V>::type v2 = {T(1), T(2)};
    test.constructed(v2, "v2");
    typename eagine::simd::data<T, 3, V>::type v3 = {T(1), T(2), T(3)};
    test.constructed(v3, "v3");
    typename eagine::simd::data<T, 4, V>::type v4 = {T(1), T(2), T(3), T(4)};
    test.constructed(v4, "v4");
    typename eagine::simd::data<T, 5, V>::type v5 = {
      T(1), T(2), T(3), T(4), T(5)};
    test.constructed(v5, "v5");
...
void vect_data_copy_construction_TV(Suite& s) {
    ...
    typename eagine::simd::data<T, 1, V1>::type v1{};
    typename eagine::simd::data<T, 1, V2>::type v1c(v1);
    test.constructed(v1c, "v1c");
    typename eagine::simd::data<T, 2, V1>::type v2{};
    typename eagine::simd::data<T, 2, V2>::type v2c(v2);
    test.constructed(v2c, "v2c");
    typename eagine::simd::data<T, 3, V1>::type v3{};
    typename eagine::simd::data<T, 3, V2>::type v3c(v3);
    test.constructed(v3c, "v3c");
    typename eagine::simd::data<T, 4, V1>::type v4{};
    typename eagine::simd::data<T, 4, V2>::type v4c(v4);
    test.constructed(v4c, "v4c");
    typename eagine::simd::data<T, 5, V1>::type v5{};
    typename eagine::simd::data<T, 5, V2>::type v5c(v5);
    test.constructed(v5c, "v5c");
    typename eagine::simd::data<T, 6, V1>::type v6{};
    typename eagine::simd::data<T, 6, V2>::type v6c(v6);
    test.constructed(v6c, "v6c");
    typename eagine::simd::data<T, 7, V1>::type v7{};
    typename eagine::simd::data<T, 7, V2>::type v7c(v7);
    test.constructed(v7c, "v7c");
    typename eagine::simd::data<T, 8, V1>::type v8{};
    typename eagine::simd::data<T, 8, V2>::type v8c(v8);
...
void vect_data_elements_TV(eagitest::case_& test) {
    ...
    typename eagine::simd::data<T, 3, V>::type v3{T(2), T(3), T(4)};
    test.check_equal(v3[0], T(2), "2");
    test.check_equal(v3[1], T(3), "3");
    test.check_equal(v3[2], T(4), "4");

    typename eagine::simd::data<T, 4, V>::type v4 = {T(3), T(4), T(5), T(6)};
...
void vect_data_add_TNV(eagitest::case_& test) {
    ...
    for(unsigned k = 0; k < test.repeats(1000); ++k) {
        ...
        typename eagine::simd::data<T, N, V>::type vNa = {};
        typename eagine::simd::data<T, N, V>::type vNb = {};
        ...
        typename eagine::simd::data<T, N, V>::type vNc = vNa + vNb;
        typename eagine::simd::data<T, N, V>::type vNd = vNb + vNa;
...
void vect_data_divide_TNV(eagitest::case_& test) {
    ...
    for(unsigned k = 0; k < test.repeats(1000); ++k) {
        ...
        typename eagine::simd::data<T, N, V>::type vNc =
          eagine::simd::sdiv<T, N, V>::apply(vNa, vNb);
        typename eagine::simd::data<T, N, V>::type vNd =
          eagine::simd::sdiv<T, N, V>::apply(vNb, vNa);
