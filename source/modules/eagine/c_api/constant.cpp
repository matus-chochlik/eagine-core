...
///
export module eagine.core.c_api:constant;
...
//------------------------------------------------------------------------------
export template <typename ClassList, typename Constant, typename Tag, bool isIndexed>
struct get_opt_constant;

export template <typename ClassList, typename T, T value, typename Tag, bool isIndexed>
...
export template <typename ClassList, typename T, typename Tag, bool isIndexed>
