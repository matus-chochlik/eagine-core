...
export template <typename Dst, typename Src>
[[nodiscard]] constexpr auto limit_cast(Src value) noexcept -> Dst
...
[[nodiscard]] constexpr auto signedness_cast(Src value) noexcept {
...
[[nodiscard]] constexpr auto span_size(const T v) noexcept {
...
/// @ingroup type_utils
export template <typename T>
[[nodiscard]] constexpr auto span_align_of(
...
/// @ingroup type_utils
export [[nodiscard]] constexpr auto max_span_align() noexcept {
...
/// @ingroup type_utils
export template <typename T>
[[nodiscard]] constexpr auto span_size_of(
  const std::type_identity<T> = {}) noexcept {
...
[[nodiscard]] constexpr auto are_safe_to_add(Int l, Int r) noexcept -> bool {
...
[[nodiscard]] constexpr auto safe_add(I i) noexcept {
    return i;
}
//------------------------------------------------------------------------------
export template <std::integral L, std::integral R>
[[nodiscard]] constexpr auto safe_add(L l, R r) noexcept {
...
[[nodiscard]] constexpr auto safe_add(A a, B b, C c) noexcept {
    return safe_add(safe_add(a, b), c);
}
//------------------------------------------------------------------------------
export template <std::integral A, std::integral B, std::integral C, std::integral D>
[[nodiscard]] constexpr auto safe_add(A a, B b, C c, D d) noexcept {
...
export template <
  ...
  std::integral E,
  std::integral... P>
[[nodiscard]] constexpr auto safe_add(A a, B b, C c, D d, E e, P... p) noexcept {
...
[[nodiscard]] constexpr auto args_within_limits_of(const Args&... args) noexcept
  -> bool
...
[[nodiscard]] constexpr auto args_within_limits(
  RV (*)(Params...),
