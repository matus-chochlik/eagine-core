...
misalignment(const span_size_t addr, const span_size_t alignment) noexcept
  -> span_size_t {
...
/// @ingroup memory
static constexpr auto
misalignment(const std::nullptr_t, const span_size_t) noexcept -> span_size_t {
    return 0;
}
//------------------------------------------------------------------------------
...
/// @ingroup memory
static constexpr auto
is_aligned_to(const span_size_t addr, const span_size_t algn) noexcept {
...
/// @ingroup memory
static constexpr auto
is_aligned_to(const std::nullptr_t, const span_size_t) noexcept {
    return true;
}
//------------------------------------------------------------------------------
...
template <typename T>
static constexpr auto
is_aligned_as(const span_size_t addr, const type_identity<T> = {}) noexcept {
