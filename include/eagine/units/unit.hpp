...
static constexpr auto operator!(U) noexcept
  -> lit_result_t<U> requires(is_unit_v<U>) {
    return {};
}
...
static constexpr auto operator+(U1, U2) noexcept
  -> add_result_t<U1, U2> requires(is_unit_v<U1>&& is_unit_v<U2>) {
    return {};
}
...
template <typename U1, typename U2>
static constexpr auto operator-(U1, U2) noexcept
  -> sub_result_t<U1, U2> requires(is_unit_v<U1>&& is_unit_v<U2>) {
    return {};
}
...
template <typename U1, typename U2>
static constexpr auto operator*(U1, U2) noexcept
  -> mul_result_t<U1, U2> requires(is_unit_v<U1>&& is_unit_v<U2>) {
    return {};
}
...
template <typename U1, typename U2>
static constexpr auto operator/(U1, U2) noexcept
  -> div_result_t<U1, U2> requires(is_unit_v<U1>&& is_unit_v<U2>) {
    return {};
}
